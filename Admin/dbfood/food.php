...
<nav style="background-color:#115c7b" class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  
    <a class="navbar-brand" href="index.php"><span style="color:green;font-family: 'Permanent Marker', cursive;">Ummed:The_Hope</span></a>
...
<br><br>
<div class="middle" style=" padding:40px; border:1px solid #115c9b;  width:100%;">
       <!--tab heading-->
	   <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background-color:#115c9b;border-radius:10px 10px 10px 10px;" role="tablist">
          <li class="nav-item">
            ...
            <div class="tab-pane fade show active" id="viewitem" role="tabpanel" aria-labelledby="home-tab">
			 ...
			 <th>Update item Details </th>
			   <?php
				...
				<a href="update.php?food_id=<?php echo $row['food_id'];?>"><button style="background-color:#115c9b"type="button" class="btn btn-danger">Update </button></a>
